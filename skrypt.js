/*
   ...
   Project: Wybór Junglera
   Version: 1.02
   Used solutions: HTML, CSS, JavaScript
*/
...
function Winwheel(options, drawWheel)
{
    defaultOptions = {
        ...
        'textFontFamily'    : 'Comic Sans MS',      // Segment text font, you should use web safe fonts.
        'textFontSize'      : 2,           // Size of the segment text.
